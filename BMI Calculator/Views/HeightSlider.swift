...
struct HeightSlider: View {
    ...
    init(value: Binding<Double>) {
        ...
        let thumbImage = UIImage(systemName: "circle.fill", withConfiguration: config)?.withTintColor(UIColor(named: "bottom-container") ?? .systemRed, renderingMode: .alwaysOriginal)
